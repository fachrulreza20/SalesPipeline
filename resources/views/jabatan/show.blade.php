...
<h3>Edit jabatan</h3>
<br>
<form autocomplete="off" class="form" action="/jabatanUpdate/{{ $data->id }}" method="post" enctype="multipart/form-data">
  @csrf

  <div class="mb-3 row">
    <label for="RezaField" class="col-sm-2 col-form-label">jabatan Name</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="jabatan_ket" value="{{ $data->jabatan_ket}}">
    </div>
  </div>
