...
@section('container')
    ...
    <div class="row">
      ...
      <div class="row mt-2">
        ...
        <h5 class="mb-4">Data Nasabah Downgrade ke NPF (Kol 3/Kol4/Kol5) Cabang {{ (sizeof($data)>0) ? $data[0]['namaoutlet'] : '-' }}</h5> 
        <form action="/nasabahnpf/1" method="POST">
        @csrf
        {{ method_field('PATCH') }} 
